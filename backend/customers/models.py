...
class Customers(models.Model):
    ...
    sold_with = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='sold_with_options')
    ...
    design_requested = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='design_requested_options')
    pe_stamp_requested = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='pe_stamp_requested_options')
    permit_submitted = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='permit_submitted_options')
    ic_submitted = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='ic_submitted_options')
    permit_approved = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='permit_approved_options')
    ic_approved = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='ic_approved_options')
    install_date = models.CharField(max_length=255, null=True)
    install_confirmed = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='install_confirmed_options')
    equipment_ordered = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='equipment_ordered_options')
    install_complete = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='install_complete_options')
    ...
    battery = models.ForeignKey('CustomerSelectOptions', models.SET_NULL, null=True, blank=True, related_name='battery_options')
